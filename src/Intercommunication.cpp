...
Intercommunication::Intercommunication(char* myIP, char*peerIP)
{
...
int Intercommunication::send_gps_position(mavlink_global_position_int_t meas){
...
int Intercommunication::receive_gps_position(){
